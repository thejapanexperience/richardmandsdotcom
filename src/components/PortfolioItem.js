  ...
  render() {
    ...
    if (data.link){
      links = data.link.map((lnk, i) => {
        if (i === 1){
          return <div key={i}><a href={url + lnk} target="_blank">github</a><br/></div>;
        }
        if (i === 2){
          return <div key={i}><a href={url + lnk} target="_blank">youtube</a><br/></div>;
        }
        if (i === 3){
          return <div key={i}><a href={url + lnk} target="_blank">twitter</a><br/></div>;
        }
        return <div key={i}><a href={url + lnk} target="_blank">{lnk}</a><br/></div>;
      });
    } else {
      links = <div key="noLinks"><a href="#" target="_blank">nothingYet</a><br/></div>;
    }
